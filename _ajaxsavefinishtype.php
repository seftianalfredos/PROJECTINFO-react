...
$query2 = $DBcon->prepare("SELECT type_id FROM table_type ORDER BY type_id DESC LIMIT 1");
$query2->execute();
while ($rows = $query2->fetch(PDO::FETCH_ASSOC)) {
	$type_id            = $rows['type_id'];

	$query3 = $DBcon->prepare("INSERT INTO table_revisitype SET type_id = :type_id, revCode = :revCode, revDate = :revDate, tit_id = :tit_id, DepartementID = :DepartementID ");
...
$query4 = $DBcon->prepare("SELECT *FROM table_type tt JOIN table_product tp ON tt.prd_id = tp.prd_id ORDER BY type_id DESC LIMIT 1");
$query4->execute();
while ($rows = $query4->fetch(PDO::FETCH_ASSOC)) {
	$type_id 		= $rows['type_id'];
	$ProductName	= $rows['ProductName'];

	switch ($ProductName) {
		case 'Air Conditioner':
		$query5 = $DBcon->prepare("INSERT INTO table_specac SET type_id = :type_id, dimension_id = 1, refrigerant_id = 1");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
		case 'Chest Freezer':
		$query5 = $DBcon->prepare("INSERT INTO table_speccf SET type_id = :type_id, dimension_id = 1, rollbond_id = 1, rollbondtype_id = 1, temperature_id = 1, climate_id = 1, condensor_id = 1, refrigerant_id = 1, rv_id = 1, wv_id = 1 ");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
		case 'Showcase':
		$query5 = $DBcon->prepare("INSERT INTO table_specsc SET type_id = :type_id, color_id = 1, rack_id = 1, dimension_id = 1, rollbond_id = 1, rollbondtype_id = 1, climate_id = 1, condensor_id = 1, refrigerant_id = 1, rv_id = 1, wv_id = 1 ");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
		case 'Refrigerator':
		$query5 = $DBcon->prepare("INSERT INTO table_specrf SET type_id = :type_id, color_id = 1, pattern_id = 1, finishing_id = 1, handle_id = 1, rack_id = 1, dimension_id = 1, packing_id = 1, rollbond_id = 1, rollbondtype_id = 1, temperature_id = 1, climate_id = 1, condensor_id = 1, refrigerant_id = 1, rv_id = 1, wv_id = 1 ");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
		case 'Washing Machine':
		$query5 = $DBcon->prepare("INSERT INTO table_specwm SET type_id = :type_id, color_id = 1, dimension_id = 1, rv_id = 1, wv_id = 1 ");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
		case 'Water Dispenser':
		$query5 = $DBcon->prepare("INSERT INTO table_specwd SET type_id = :type_id, color_id = 1, dimension_id = 1, rollbond_id = 1, rollbondtype_id = 1, climate_id = 1, condensor_id = 1, refrigerant_id = 1, rv_id = 1, wv_id = 1 ");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
		default:
		$query5 = $DBcon->prepare("INSERT INTO table_specother SET type_id = :type_id, color_id = 1, dimension_id = 1 , rv_id = 1, wv_id = 1 ");
		$query5->bindParam(':type_id', $type_id);
		$query5->execute();
		break;
	}
