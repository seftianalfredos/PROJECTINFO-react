...
$elecMaxLamp	= '';
$ElecSpecDesign	= '';
$target_dir 	= '_upload/artSpecDesign/';
$target_dir2	= '_upload/mecSpecDesign/';
$target_dir3	= '_upload/cycSpecDesign/';
$target_dir4	= '_upload/elecSpecDesign/';
...
if (isset($_FILES['ArtSpecDesign']['name'])) {
	...
	$target_file 	 = $target_dir.$ArtSpecDesign;
...
if (isset($_FILES['MechSpecDesign']['name'])) {
	...
	$target_file2 	 = $target_dir2.$MechSpecDesign;
...
if (isset($_FILES['CycSpecDesign']['name'])) {
	...
	$target_file3 	 = $target_dir3.$CycSpecDesign;
...
if (isset($_FILES['ElecSpecDesign']['name'])) {
	...
	$target_file4 	 = $target_dir4.$ElecSpecDesign;
...
$stmt->bindParam(':ArtSpecDesign',			$ArtSpecDesign);
...
$stmt->bindParam(':MechSpecDesign',			$MechSpecDesign);
...
$stmt->bindParam(':CycSpecDesign',			$CycSpecDesign);
...
$stmt->bindParam(':ElecSpecDesign',			$ElecSpecDesign);
